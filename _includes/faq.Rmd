...
## What is the Euler-multinomial approximation?
...
```{r compartment-diagram,echo=FALSE,purl=FALSE,out.width="200px",out.height="200px",dpi=100,fig.height=3,fig.width=3,fig.align="center",fig.cap="**Diagram:** *A single compartment within a compartmental model.  There are $s$ paths out of the compartment.  Here, $s=2$.*"}
library(grid)
