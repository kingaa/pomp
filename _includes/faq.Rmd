...
## When trying to use Csnippets, I get an error message that refers to files and directories that don't exist. What is going on?
...
For the tools that compile the Csnippets---as with (all?) other command-line tools---whitespace is syntactic.
