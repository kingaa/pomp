...
##'
##' There are thus altogether ten \bold{basic model components}:
##' \enumerate{
...
##' \item \link[=emeasure specification]{emeasure}, which computes the conditional expectation of the measurement model, given the latent states,
