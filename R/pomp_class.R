...
setClass(
  ...
  prototype=prototype(
    ...
    default.init=TRUE,
    initializer=pomp_fun(slotname="initializer"),
    ...
    has.trans=FALSE,
    from.trans=pomp_fun(slotname="fromEstimationScale"),
    to.trans=pomp_fun(slotname="toEstimationScale"),
    solibs=list(),
    userdata=list()
  ),
