...
##' One specifies how to evaluate the probability density function for this distribution using the \code{dinit} argument.
##' As usual, this can be provided either as a C snippet or as an \R function.
##' In the former case, bear in mind that:
##' \enumerate{
##'   \item The goal of a this snippet is computation of a log likelihood.
...
##' \code{f} must return a single numeric value.
##'
