...
\Abstract{
  ...
  \noindent
  *This document is an updated version of \href{https://doi.org/10.18637/jss.v069.i12}{\emph{Journal of Statistical Software} \textbf{69}(12): 1--43}.
...
nlf1 <- nlf_objfun(gomp, ti=100, tf=4000, lags = c(2, 3),
  ...
  est = c("r", "sigma", "tau"))
subplex(par = c(r=0.2, sigma=0.15, tau=0.08), fn=nlf1,
  control=list(reltol=1e-4)) -> nlf1_out
nlf1(nlf1_out$par)
@
...
\newblock \urlprefix\url{https://nlopt.readthedocs.io/en/latest/}.
...
\newblock \proglang{R}~package, \urlprefix\url{https://CRAN.R-project.org/package=subplex}.

\bibitem[{King \emph{et~al.}(2024)King, Ionides, Bret\'o, Ellner, Ferrari, Funk, Johnson, Kendall, Lavine, Nguyen, O'Dea, Reuman, Wearing, and Wood}]{pomp}
King AA, Ionides EL, Bret\'o CM, Ellner SP, Ferrari MJ, Funk S, Johnson SG, Kendall BE, Lavine M, Nguyen D, O'Dea EB, Reuman DC, Wearing H, Wood SN (2024).
\newblock \emph{{pomp}: {Statistical} Inference for Partially Observed {Markov} Processes}.
\newblock \proglang{R}~package, \urlprefix\url{https://kingaa.github.io/pomp/}.
...
\newblock \proglang{R} package \urlprefix\url{https://CRAN.R-project.org/package=foreach}.
...
\newblock \proglang{R}~package, \urlprefix\url{https://CRAN.R-project.org/package=nloptr}.
