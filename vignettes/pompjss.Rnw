...
This approach has been used in a variety of previously proposed POMP methodologies \citep{Kitagawa1998,Liu2001,Wan2000} but iterated filtering is distinguished by having theoretical justification for convergence to the maximum likelihood estimate \citep{Ionides2011}.
