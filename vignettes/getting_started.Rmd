...
```{r sim1_spy,eval=FALSE,purl=FALSE}
spy(sim1)
```
...
```{r sim2_spy,eval=FALSE,purl=FALSE}
spy(sim2)
```
```{r sim2_print_plot}
as(sim2,"data.frame")
...
```{r vp1,eval=FALSE,include=FALSE,purl=FALSE}
parus %>%
  pomp(
    times="year", t0=1960,
    rinit=function (N_0, ...) {
...
```{r cluster_setup,purl=TRUE,include=FALSE}
