...
Produced using *R* version `r getRversion()` and **pomp2** version `r packageVersion("pomp2")`.
...
The full 20 city dataset is available on [the **pomp** website](http://kingaa.github.io/pomp/vignettes/) and the MLEs obtained by @He2010 for the full 20 towns are included in the R code accompanying this document.
...
We use the **foreach** and **doMC** packages to parallelize the computations on a multicore machine.
