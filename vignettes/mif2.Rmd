...
See the **pomp2** documentation (`?pomp`) and the section on Parameter Transformations in the [Getting Started vignette](https://kingaa.github.io/pomp/vignettes/getting_started.html)).
