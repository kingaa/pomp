...
It is meant to be directly comparable with the example displayed in the @King2016 [*J. Stat. Softw.* paper](http://kingaa.github.io/pomp/vignettes/pompjss.pdf).
...
```{r gompertz-post-mif2,include=FALSE}
...
Compare this with the [performance of IF1 (`mif`) on the same task](http://kingaa.github.io/pomp/vignettes/pompjss.pdf#page=20).
...
## [**R** codes for this document](http://raw.githubusercontent.com/kingaa/pomp/gh-pages/vignettes/mif2.R)
