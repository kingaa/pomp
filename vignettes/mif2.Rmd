...
This document was produced using **pomp2** version `r packageVersion("pomp2")`.
...
In **pomp2**, it is the particle filter that is iterated.
...
The following constructs the Gompertz example that is provided with **pomp2** (see `?gompertz`) and extracts the parameters at which the data were generated.
...
See the **pomp2** documentation (`?pomp`) and the section on Parameter Transformations in the [Getting Started vignette](http://kingaa.github.io/pomp/vignettes/getting_started.html)).
