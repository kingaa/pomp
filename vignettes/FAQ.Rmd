...
The following example illustrates this for a multivariate Ornstein-Uhlenbeck process (as in the `pompExample("ou2")`) with a slightly peculiar measurement model.
