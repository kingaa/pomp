...
If you still have a problem, then submit a request for help via the [Issues page](https://github.com/kingaa/pomp/issues).
...
See [this entry to the "Pimp my pomp" wiki](https://github.com/kingaa/pomp/wiki/pimp-my-pomp#how-can-i-include-a-vector-of-variables-in-a-csnippet).
