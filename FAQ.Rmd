...
## I have an error message that I don't understand, and my question isn't answered [below](./FAQ.html#4_error_messages). How can I get help?
...
In doing so, please [follow the instructions in FAQ 1.1 above](./FAQ.html#11_how_can_i_submit_an_effective_request_for_help).
...
See [the preceding FAQ](#why-cant-i-run-the-demos-or-other-codes-that-use-the-c-snippet-facility).
...
However, the `mif2` likelihood is not identical to the true likelihood (see [FAQ 5.1](#51_is_the_likelihood_mif_gives_me_the_same_as_the_likelihood_i_get_from_pfilter)).
