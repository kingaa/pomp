...
#### [Back to **pomp** homepage](./index.html) {.unnumbered .toc-ignore}
...
## I have an error message that I don't understand, and my question isn't answered [below](./FAQ.html#error-messages). How can I get help?
...
In doing so, please [follow the instructions in FAQ 1.1 above](./FAQ.html#effective-request).

# Installation problems

## How do I install **pomp**?
...
## What is the best measurement model to use?
...
## I get the error message 'could not find symbol "recursive" in environment of the generic function' when I use the `c` operator to concatenate certain kinds of **pomp** structures. How do I fix this?
...
## Why does the likelihood seem to be decreasing, not increasing, with `mif2` iterations?
...
#### [Top](./FAQ.html) {.unnumbered .toc-ignore}
#### [Back](./index.html) {.unnumbered .toc-ignore}
